...
> ✅ Реализовано: 7 | ⚠️ Расходится: 2 | ❌ Не реализовано: 2
...
| Streak recovery | 50 coins / Ad | Don't lose streak | <!-- ✅ реализовано (RecoverStreakUseCase) --> |
| Premium subscription | Monthly | Auto-upgrade chest +1 tier | <!-- ⚠️ интерфейс + NoopPremiumService stub; логика апгрейда не применяется --> |
