...
2. [Экраны приложения](#экраны-приложения)
   - [1. Главная страница (Quiz List)](#1-главная-страница-quiz-list)
...
2. Авторегистрация (Telegram Auth)
   ↓
3. Главная страница - Список квизов
   ↓
4. Клик на квиз → Детали квиза
   ↓
5. Клик "Start Quiz" → Начало игры
   ↓
6. Прохождение вопросов (Question by Question)
   │  • Выбор ответа
   │  • Мгновенная обратная связь
   │  • Переход к следующему
   ↓
7. Завершение квиза → Экран результатов
   ↓
8. Просмотр Leaderboard
   ↓
9. Возврат к списку квизов (новая попытка или другой квиз)
```
...
### 1. Главная страница (Quiz List)

**Назначение:** Показать доступные квизы, мотивировать к прохождению
...
#### 1. QuizCard
```
Использование: Главная страница, поиск
Props:
  - quiz: Quiz
